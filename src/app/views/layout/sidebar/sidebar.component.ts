...
import { DRIVERMENU, PRODUCERMENU, ADMINMENU, WHOLESALERMENU } from './menu';
...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    if (role === 'Admin') {
      ...
      this.menuItems = WHOLESALERMENU;
    } else if (role === 'Produttore') {
      this.menuItems = PRODUCERMENU;
    } else if (role === 'Trasportatore') {
      this.menuItems = DRIVERMENU;
    }
